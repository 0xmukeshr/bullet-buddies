...
// Dynamically import DebugPanel to avoid SSR issues
const DebugPanel = dynamic(
  () => import('./ui/debug-panel'),
  {
    ssr: false,
    loading: () => <div />
  }
        ...
        return (
          <div className="fixed inset-0 bg-black bg-opacity-95 flex items-center justify-center z-50">
            <div className="text-center text-white max-w-md mx-auto p-8">
              {/* Game Over Title */}
              <h1 className="text-7xl font-bold text-red-500 mb-12 animate-pulse drop-shadow-2xl whitespace-nowrap">
                GAME OVER
              </h1>
              ...
              <div className="mb-12">
                <img 
                  ...
                  className="w-48 h-48 mx-auto rounded-xl shadow-2xl border-4 border-red-500"
                />
              </div>
